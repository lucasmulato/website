...
const APP_NAME = "Lucas Mulato · AI Red Teamer";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Lucas Mulato — AI red teamer. Adversarial research against LLMs, autonomous agents, and RAG pipelines. Builder of LLM-SEC.",
      },
